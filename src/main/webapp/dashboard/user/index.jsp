...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <a href="${pageContext.request.contextPath}/dashboard/user?action=create" class="btn btn-primary mb-3">
                Thêm người dùng
            </a>
                ...
                <table id="userTable" class="table table-striped table-bordered">
                    ...
                    <c:forEach var="user" items="${users}">
                        <tr>
                            <td>${user.id}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/dashboard/user?action=detail&id=${user.id}">
                                        ${user.username}
                                </a>
                            </td>
                            <td>${user.email}</td>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/dashboard/user?action=detail&id=${user.id}" class="btn btn-sm btn-warning">Chỉnh sửa</a>
                                <form action="${pageContext.request.contextPath}/dashboard/user" method="post" style="display:inline;">
